...
def do_scatter1(full_merged):
    ...
    print("The group of points on the right side of the plot have a higher prediction for a felony charge. Most of the points on this side of the plot are also actual felonies, meaning that as the predicted felony value goes up, the current charge is more likely to be a felony. Interestingly, this behavior is not mirrored on the y-axis. There are many felonies that also have a high predicted value for a nonfelony.")
